...
for(int i =0; i<150; i++){
LATD=0x02;
_delay((unsigned long)((1326)*(8000000/4000000.0)));
LATD=0x00;
_delay((unsigned long)((18674)*(8000000/4000000.0)));
...
for(int i =0; i<150; i++){
LATD=0x02;
_delay((unsigned long)((1953)*(8000000/4000000.0)));
LATD=0x00;
_delay((unsigned long)((18047)*(8000000/4000000.0)));
...
for(int i =0; i<150; i++){
LATD=0x02;
_delay((unsigned long)((2580)*(8000000/4000000.0)));
LATD=0x00;
_delay((unsigned long)((17420)*(8000000/4000000.0)));
